...
const LocationCard: React.FC<LocationCardProps> = ({ outlet }) => {
  ...
  return (
    <div className="bg-white border border-gray-100 rounded-2xl shadow-lg hover:shadow-xl p-3 md:p-5 mb-2 md:mb-3 last:mb-0 transition-all duration-300 ease-out backdrop-blur-sm hover:scale-[1.02]">
      {/* Header - Restaurant Name */}
      <div className="mb-2 md:mb-4">
        <h3 className="font-bold text-base md:text-lg text-transparent bg-gradient-to-r from-red-600 to-red-500 bg-clip-text leading-tight">
          {outlet.name}
        </h3>
      </div>
        ...
        <div className="flex items-center gap-3 md:gap-6">
          ...
          {outlet.distance && (
            <div className="flex items-center gap-1 md:gap-2">
              <div className="w-3 h-3 md:w-4 md:h-4 flex-shrink-0">
                <svg
              ...
              <span className="text-xs md:text-sm font-semibold text-blue-600 bg-blue-50 px-1.5 md:px-2 py-0.5 md:py-1 rounded-full">
                {outlet.distance}
              </span>
            </div>
          )}
        ...
        <div className="pt-1 md:pt-2">
          {outlet.wazeLink ? (
            <button
              ...
              className="inline-flex items-center gap-1 md:gap-2 px-3 md:px-4 py-2 md:py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white text-xs md:text-sm font-semibold rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 shadow-md hover:shadow-lg transform hover:scale-105"
            >
              <svg
